    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 sm:py-20 lg:py-24">
        <div className="container mx-auto text-center max-w-4xl">
          <div className="mb-8">
            <div className="inline-flex items-center px-4 py-2 bg-primary/10 rounded-full text-sm font-medium text-primary mb-6 sm:mb-8">
              <Zap className="w-4 h-4 mr-2" />
              Science-backed habit formation
            </div>
            <h1 className="text-4xl font-bold mb-6 leading-tight sm:text-5xl md:text-6xl lg:text-7xl">
              Rewire your brain,{" "}
              <span className="text-gradient">one habit at a time</span>
            </h1>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed sm:text-xl">
          ...
          <div className="flex flex-col gap-4 justify-center mb-12 sm:flex-row sm:gap-6">
            <Button 
              size="lg" 
              onClick={onGetStarted}
              className="h-14 px-8 bg-primary hover:bg-primary/90 text-lg font-semibold min-h-[56px] sm:h-16 sm:px-10"
            >
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="h-14 px-8 text-lg font-semibold min-h-[56px] sm:h-16 sm:px-10"
            >
              Watch Demo
            </Button>
          </div>
            ...
            {features.map((feature, index) => (
              <Card key={index} className="border-border/50 bg-card/50 backdrop-blur-sm">
                <CardContent className="p-6 text-center sm:p-8">
                  ...
                  <h3 className="text-xl font-semibold mb-3 sm:text-2xl">{feature.title}</h3>
